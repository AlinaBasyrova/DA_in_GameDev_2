...
- Написать скрипт для воспроизведения звуков, в зависимости от значения в таблице. Значения >= 18 - хорошо, значения <18 и >6 - нормально, значения <6 - все очень очень плохо.
- Наслаждаемся результатом, милорд.
...
В процессе выполнения лабораторной работы я научилась я научилась заполнять гугл таблицы с помощью Python, а также передавать данные из таблицы в Unity. 
